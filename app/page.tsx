                ...
                <div key={project.id} className="flex items-center gap-3 py-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-medium text-zinc-800 truncate">{project.name}</span>
          ...
          <Card>
            ...
            <CardContent className="pt-0 space-y-1">
              ...
              {recentTasks.map(task => {
                ...
                return (
                  <div key={task.id} className="flex items-center gap-3 py-2 border-b border-zinc-50 last:border-0">
                    <div className="h-2 w-2 rounded-full shrink-0" style={{ backgroundColor: project?.color ?? '#94A3B8' }} />
                    <div className="flex-1 min-w-0">
                      <div className="text-sm font-medium text-zinc-800 truncate">{task.name}</div>
